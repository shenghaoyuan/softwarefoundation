...
Proof.
  induction l1; intros; simpl; try reflexivity.
  - rewrite app_nil_r.
    reflexivity.
  - rewrite IHl1.
    rewrite app_assoc.
...
Theorem rev_injective : forall (l1 l2 : natlist),
  rev l1 = rev l2 -> l1 = l2.
Proof.
  assert (Hl: forall (f : natlist -> natlist),
...
Proof.
  induction x; intros; simpl; try reflexivity.
  apply eqb_refl.
Qed.
(** [] *)
